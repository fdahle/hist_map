...
export const useSettingsStore = defineStore("settings", () => {
  ...
  const restoreMapPosition = createPersistedRef("settings_restoreMapPosition", false);
  ...
  const toggleRestoreMapPosition = () => { restoreMapPosition.value = !restoreMapPosition.value; };
